              ...
              Row(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Per vori price : ${widget.newSellDetails["tk"]} TK",
                          style: AllTextStyle().goldName),
                      SizedBox(height: 10.h),
                      Text(
                          "Products price : ${widget.newSellDetails["products-price"]} TK",
                          style: AllTextStyle().goldName),
                      SizedBox(height: 10.h),
                      Text(
                          "Total price : ${widget.newSellDetails["total-price"]} TK",
                          style: AllTextStyle().goldName),
                      SizedBox(height: 10.h),
                      Text("Pay : ${widget.newSellDetails["pay"]} TK",
                          style: AllTextStyle().goldName),
                      SizedBox(height: 10.h),
                      Text("Pay : ${widget.newSellDetails["mujuri"]} TK",
                          style: AllTextStyle().goldName),
                    ],
                  ),
                ],
