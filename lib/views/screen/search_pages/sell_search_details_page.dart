        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10.h),
              Text("Per vori price : ${totalMoney} TK", style: AllTextStyle().goldName),
              SizedBox(height: 10.h),
              Text("Products price : ${productsprice} TK", style: AllTextStyle().goldName),
              SizedBox(height: 10.h),
              Text("Total price : ${totalprice} TK", style: AllTextStyle().goldName),
              SizedBox(height: 10.h),
              Text("Discount : ${discount} TK", style: AllTextStyle().goldName),
              SizedBox(height: 10.h),
              Text("Pay : ${pay} TK", style: AllTextStyle().goldName),
              SizedBox(height: 10.h),
              Text("Mujuri : ${mujuri} TK", style: AllTextStyle().goldName),
              SizedBox(height: 20.h),
              InkWell(
                onTap: (){
