...
class MortgageSearchPage extends StatefulWidget {
  const MortgageSearchPage({super.key});

  @override
  State<MortgageSearchPage> createState() => _MortgageSearchPageState();
}

class _MortgageSearchPageState extends State<MortgageSearchPage> {
  var inputText = "";
  @override
